...
const InfoTab = ()=> {
    ...
    useEffect(()=> {
        ...
        return [
            <AppNav serverInfo={serverInfo} clientInfo={clientInfo} collapse={collapse} toggle={toggle} key={0}/>,
                ...
                <div id="content">
                    <section className="row colset-2-its">
                        ...
                        <div id="controllers" role="navigation">
                            ...
                            <ul>
                                {serverInfo && serverInfo.controllers ? serverInfo.controllers.map(controller => {
